...
export const project: Project = {
    ...
    "template": "full",
    "overview": {
        "client": 'Markey Insurance',
        "website": 'http://www.markeygroup.com.au',
        "agency": 'Thurnham Teece',
        "role": 'Visual strategy, logo, website, icons.',
        "blurb": "Identity and digital solutions for an insurance and risk management group.",
        "images": {
    ...
    "detail": {
        "masthead": {
            "blurb": "<p>Markey is one of the largest locally owned and managed insurance brokerages in Australia.</p><p>They teamed up with Thurnham Teece to create an identity that reflected simple and effective insurance and risk management.</p>",
            "image": "./assets/projects/markey/mast.jpg?v=1"
        },
        "intro": {
